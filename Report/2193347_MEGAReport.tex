...
Also, I have learned to not give functions "secret" operations; a bug that took an hour to figure out was caused by my Cross product function normalising the 
vectors before calculating the cross product. This was configurable with a boolean parameter, but it has a default value, so I did not realise for a long time.
